...
// ajuste o caminho se auth.interceptor.ts estiver em outra pasta
...
bootstrapApplication(AppComponent, {
  providers: [
    ...
    // o authInterceptor anexa o token automaticamente em toda requisição,
    // então as páginas não precisam mais montar HttpHeaders manualmente
  ],
});